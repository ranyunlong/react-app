...
import { Router, useHref, createPath, useLocation, useResolvedPath, useNavigate } from '@quick-toolkit/react-router';
export { MemoryRouter, Navigate, NavigationType, Outlet, Route, Router, Routes, UNSAFE_LocationContext, UNSAFE_NavigationContext, UNSAFE_RouteContext, createPath, createRoutesFromChildren, generatePath, matchPath, matchRoutes, parsePath, renderMatches, resolvePath, useHref, useInRouterContext, useLocation, useMatch, useNavigate, useNavigationType, useOutlet, useOutletContext, useParams, useResolvedPath, useRouteContext, useRouteCurrent, useRoutes } from '@quick-toolkit/react-router';

/**
 * NOTE: If you refactor this to split up the modules into separate files,
 * you'll need to update the rollup config for react-rc-router-dom-v5-compat.
 */
...
/**
 * Handles the click behavior for rc-router `<Link>` components. This is useful if
...
//# sourceMappingURL=react-rc-router-dom.development.js.map
